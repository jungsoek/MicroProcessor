 ...
 **딥러닝 연산**(행렬 곱셈, Convolution, Activation 등)에서는 성능과 전력 효율이 낮아.
 ...
 **일반 영역(Non-Secure World)**을 **하드웨어적으로 분리**해주는 기술이야.
...
양자 컴퓨터는 **현재의 공개키 암호(PKC)** 체계인
 RSA, ECC, DSA 등을 **Shor 알고리즘**으로 빠르게 해독 가능해.
